function [QDot, Tsubc, Wmin] = HeatFluxSSMETEST(heightStepNumber,heightStepArray,chanW,deltaP,thermalConductivity,targetTemp, fluidInfo)
%Note: Function returns [Qdot, -2, -2] if a wall thickness could not be
