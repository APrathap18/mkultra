function [flowTemp, flowVelocity, flowPressure, T_l_reqMatrix, wall_thicknesses, vmStress] = calculateWallTemp(T_l_reqMatrix, chamberDiameterArray, wall_thicknesses,channelNum, heightStepArray, flowTempMatrix, flowVelocityMatrix, flowPressureMatrix, vonMisesStressMatrix, height, width, heightValue, widthValue, newFluidProperties)
...
% heightStepNumber = 1;
    ...
    frictionFactor = (1/(-1.8*log10(((surfaceRoughness/hyd_diam)/3.7)^(1.11)+(6.9/Re))))^2;
