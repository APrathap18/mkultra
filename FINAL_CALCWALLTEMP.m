function [flowTemp,flowVelocity,flowPressure, T_wgFinal, finEfficiency, Qdot, finQdot, T_wl_Array, h_l_Array, h_g_Array, vonMises, sigma_long, sigma_circ, sigma_rad] = FINAL_CALCWALLTEMP(converge_index, throat_index, channelHeight, channelWidth, wallThickness, chamberDiameterArray, heightStepNumber, newFluidProperties, inputValues)
    ...
    % Von Mises vs Yield
        ...
        %316ss
        yieldStrength1 = (-1752.837055 + (10.95348561*T_wgFinal) +(-0.02181326907*(T_wgFinal.^2)) +(0.00001831828233*(T_wgFinal.^3))+(-0.00000000565408*(T_wgFinal.^4)))*1000000;
        UTS1 = (280.2605419 + (3.972406326*T_wgFinal) +(-0.01164851774*(T_wgFinal.^2)) + (0.00001218359239*(T_wgFinal.^3)) + (-0.0000000043875088*(T_wgFinal.^4)))*1000000;
    
        yieldStrength2 = (-1752.837055 + (10.95348561*T_wl_Array) +(-0.02181326907*(T_wl_Array.^2)) + (0.00001831828233*(T_wl_Array.^3))+(-0.00000000565408*(T_wl_Array.^4)))*1000000;
        UTS2 = (280.2605419+ (3.972406326*T_wl_Array)  +(-0.01164851774*(T_wl_Array.^2)) + (0.00001218359239*(T_wl_Array.^3))+ (-0.0000000043875088*(T_wl_Array.^4)))*1000000;
