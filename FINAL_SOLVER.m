function [T_wgFinal, flowTemp, flowPressure, flowVelocity, finEfficiency, Qdot, finQdot, T_wl_Array, h_l_Array, h_g_Array] = FINAL_SOLVER(chamberDiameterArray, heightStepNumber, newFluidInfo, channelWidths, channelHeights, wallThicknesses, inputFlowValues)
  % clc;
  % clear;
...
while (heightStep <= heightStepNumber)
    ...
    heightStepArray = linspace(0,inputFlowValues(14)/39.37,heightStepNumber);
